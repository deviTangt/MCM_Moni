...
[Water_Consumption_month, Water_Consumption_month_txt, Water_Consumption_month_raw] = xlsread("Res\MCM_5 States' Water Consumption In 2021", "A2 : F61");
...
[Supply_Rate, Supply_Rate_txt, Supply_Rate_raw] = xlsread("Res\MCM_Supply_Channel", "D2 : D11");
Supply_Rate;
...
External_Factor_Impact_ratio = xlsread("Res\MCM_RainfallShortage&Hotter's Impact on Water", "C2 : D6");
External_Factor_Impact_ratio;   % 5 * 2 

% 过去25年的Glen Canyou Dam的月度的水位信息
Glen_Canyon_Dam_WaterHeight = xlsread("Res\过去25年的Glen Canyou Dam的月度的水位信息");
Glen_Canyon_Dam_WaterHeight;    % 300 * 4

% MCM_Water of Colorado River to Gulf of Carnifornia
Water_Colorado_River2Gulf_of_Carnifornia = xlsread("Res\MCM_Water of Colorado River to Gulf of Carnifornia", "C2 : C13");
Water_Colorado_River2Gulf_of_Carnifornia;   % 12 * 1

% MCM_Water of Glen Canyon Dam to Hoover Dam
Water_Glen_Canyon_Dam2Hoover_Dam = xlsread("Res\MCM_Water of Glen Canyon Dam to Hoover Dam", "C2 : C13");
